...
echo "User can usage main.yml configuration 'args' key and value, devops framework will use it to parser input, when input has 'key' then framework will assign value to attribute variable."
echo "-----"
echo ""
## Declare variable.
local cli_vars=()
